...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference("Adventure.count") do
      post adventures_url, params: { adventure: { activity: @adventure.activity, description: @adventure.description, have_we_did_it: @adventure.have_we_did_it, location: @adventure.location } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { activity: @adventure.activity, description: @adventure.description, have_we_did_it: @adventure.have_we_did_it, location: @adventure.location } }
